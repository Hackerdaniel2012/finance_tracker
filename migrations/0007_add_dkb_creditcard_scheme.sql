...
CREATE TABLE import_profiles_new (
	...
	bank_id TEXT NOT NULL CHECK (bank_id IN ('n26', 'trade_republic', 'dkb', 'dkb_creditcard')),
	label TEXT NOT NULL,
...
INSERT INTO import_profiles_new (id, account_id, bank_id, label, status, created_at, updated_at)
...
CREATE TABLE import_batches_new (
	...
	adapter_id TEXT NOT NULL CHECK (adapter_id IN ('n26', 'trade_republic', 'dkb', 'dkb_creditcard')),
	start_date TEXT,
	end_date TEXT,
...
SELECT id, profile_id, file_hash, adapter_id, start_date, end_date, row_count,
	imported_count, duplicate_count, error_count, created_at
FROM import_batches;
